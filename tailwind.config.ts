    ...
    extend: {
      ...
      colors: {
        ...
        mystic: {
          ...
          600: "var(--mystic-600)",
          500: "var(--mystic-500)",
          gold: "var(--mystic-gold)",
          "gold-light": "var(--mystic-gold-light)",
        },
      ...
      fontFamily: {
        ...
        "mono-data": ["var(--font-inter)", "ui-monospace", "monospace"],
        "label-caps": ["var(--font-space)", "system-ui", "sans-serif"],
        "headline-md": ["var(--font-space)", "system-ui", "sans-serif"],
        "headline-lg": ["var(--font-space)", "system-ui", "sans-serif"],
        "body-lg": ["var(--font-inter)", "system-ui", "sans-serif"],
        "body-md": ["var(--font-inter)", "system-ui", "sans-serif"],
      },
      fontSize: {
        "mono-data": ["14px", { lineHeight: "1.4", letterSpacing: "0.05em", fontWeight: "500" }],
